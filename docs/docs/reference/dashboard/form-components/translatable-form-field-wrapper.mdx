...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/translatable-form-field.tsx" sourceLine="152" packageName="@vendure/dashboard" since="3.4.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/translatable-form-field.tsx" sourceLine="26" packageName="@vendure/dashboard" since="3.4.0" />
