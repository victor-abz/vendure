...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/translatable-form-field.tsx" sourceLine="150" packageName="@vendure/dashboard" since="3.4.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/translatable-form-field.tsx" sourceLine="24" packageName="@vendure/dashboard" since="3.4.0" />
