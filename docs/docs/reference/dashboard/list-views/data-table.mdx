...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/data-table/data-table.tsx" sourceLine="188" packageName="@vendure/dashboard" since="3.4.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/data-table/data-table.tsx" sourceLine="137" packageName="@vendure/dashboard" since="3.4.0" />
