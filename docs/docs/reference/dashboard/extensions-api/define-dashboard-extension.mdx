...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/define-dashboard-extension.ts" sourceLine="64" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/extension-api-types.ts" sourceLine="35" packageName="@vendure/dashboard" since="3.3.0" />
