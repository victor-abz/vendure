...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="807" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="756" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="852" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="882" packageName="@vendure/dashboard" since="3.3.0" />
