...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="819" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="866" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="896" packageName="@vendure/dashboard" since="3.3.0" />
