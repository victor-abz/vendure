...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="518" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/layout-engine/page-layout.tsx" sourceLine="694" packageName="@vendure/dashboard" since="3.3.0" />
