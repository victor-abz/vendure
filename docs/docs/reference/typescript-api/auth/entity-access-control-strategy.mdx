...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/config/auth/entity-access-control-strategy.ts" sourceLine="108" packageName="@vendure/core" since="3.6.0" experimental="true" />
