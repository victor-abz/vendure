...
- [`@vendure-community/stripe-plugin`](https://github.com/vendurehq/community-plugins)
- [`@vendure-community/braintree-plugin`](https://github.com/vendurehq/community-plugins)
- [`@vendure-community/mollie-plugin`](https://github.com/vendurehq/community-plugins)
