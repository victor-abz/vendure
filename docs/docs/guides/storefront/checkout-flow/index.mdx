...
The following community plugins provide payment integrations:

- [`@vendure-community/stripe-plugin`](https://github.com/vendurehq/vendure-community-plugins)
- [`@vendure-community/braintree-plugin`](https://github.com/vendurehq/vendure-community-plugins)
- [`@vendure-community/mollie-plugin`](https://github.com/vendurehq/vendure-community-plugins)
