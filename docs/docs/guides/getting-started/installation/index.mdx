...
Next, you will be prompted to include an official storefront starter in your project. Vendure officially supports
[TanStack Start and Next.js starters](/storefront/storefront-starters/). This step is optional, but recommended if you want to quickly see a working storefront connected to your Vendure server.
...
◇  Docker is running
│
◆  Would you like to include a storefront? # [!code highlight]
│  ○ None # [!code highlight]
│  ● TanStack Start # [!code highlight]
│  ○ Next.js # [!code highlight]
└ # [!code highlight]
```
...
│    apps/storefront - TanStack Start frontend          │
│                                                       │
│                                                       │
│  Next, run:                                           │
│  $ cd my-shop                                         │
...
- The storefront: [http://localhost:3001](http://localhost:3001/)
